...
class category_cup_model_atributos{	
    var $category_cup='';
    var $name='';
    var $date='';
    var $active='';
...
class Category_cup_Model extends CI_Model{ 

    public function __construct() {
        parent::__construct();  
        $this->table = 'category_cup';
	$this->table_id = 'category_cup_id';
        $this->category_cup_id='';
        $this->name='';
        $this->date='';
        $this->active='';
	$this->status_value='';
        ...
        $this->updated_at='';
        $this->updated_by='';
	$this->fields = new category_cup_model_atributos();
    }   
