...
class category_blog_model_atributos{	
    var $category_blog_id='';
    var $name='';
    var $date='';
    var $active='';
    var $status_value='';
...
class Category_blog_Model extends CI_Model{ 
    ...
    public function __construct() {
        parent::__construct();  
        $this->table = 'category_blog';
	$this->table_id = 'category_blog_id';
        $this->category_blog_id='';
        $this->name='';
        $this->date='';
        $this->active='';
	$this->status_value='';
        ...
        $this->updated_at='';
        $this->updated_by='';
	$this->fields = new category_blog_model_atributos();
    }   
