...
class blog_messages_model_atributos{	
    var $blog_message_id='';
    var $message_id='';
    var $blog_id='';
}

class Blog_messages_Model extends CI_Model{ 

    public function __construct() {
        parent::__construct();  
        $this->table = 'blog_messages';
	$this->table_id = 'blog_message_id';
        $this->blog_message_id='';
        $this->message_id='';
        $this->blog_id='';
	$this->fields = new blog_messages_model_atributos();
    }   
