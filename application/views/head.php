<head>
  ...
  <link rel='stylesheet' id='oxigeno-style-css' href='<?php echo site_url().'static/page_front/css/plugins/style.css?ver=4.9.8';?>' type='text/css' media='screen' />
  <link rel='stylesheet' id='oxigeno-print-css' href='<?php echo site_url().'static/page_front/css/print.css?ver=4.9.8';?>' type='text/css' media='print' />
  ...
  <link rel='stylesheet' id='boldthemes-framework-css' href='<?php echo site_url().'static/page_front/css/framework/style.css?ver=4.9.8';?>' type='text/css' media='all' />
  <script type='text/javascript' src='<?php echo site_url().'static/page_front/js/jquery.js?ver=1.12.4';?>'></script>
  <script type='text/javascript' src='<?php echo site_url().'static/page_front/js/jquery-migrate.min.js?ver=1.4.1';?>'></script>
  <script type='text/javascript' src='<?php echo site_url().'static/page_front/js/content_elements.js?ver=1';?>'></script>
  <script type='text/javascript' src='<?php echo site_url().'static/page_front/js/slick.min.js?ver=4.9.8';?>'></script>
  <script type='text/javascript' src='<?php echo site_url().'static/page_front/js/jquery.magnific-popup.min.js?ver=4.9.8';?>'></script>
  <script type='text/javascript' src='<?php echo site_url().'static/page_front/js/script_fe.js?ver=1';?>'></script>
  <script type='text/javascript' src='<?php echo site_url().'static/page_front/js/jquery.dd.js?ver=4.9.8';?>'></script>
  ...
  <script data-cfasync="false" type="text/javascript">
    //<![CDATA[
    	dataLayer.push({"pagePostType":"frontpage","pagePostType2":"single-page","pagePostAuthor":"BoldThemes"});//]]>
  </script>
