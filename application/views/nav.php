...
<!--        <ul class="sub-menu">
      ...
      <li id="menu-item-1526" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1526"><a href="<?php echo site_url().'blog';?>">Blog</a>
<!--        <ul class="sub-menu">
...
<!--      <li id="menu-item-1520" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1520"><a href="http://oxigeno.bold-themes.com/basketball/shop/">Shop</a>
      ...
      <li id="menu-item-1527" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1527"><a href="<?php echo site_url().'contact';?>">Contacto</a>
<!--        <ul class="sub-menu">
